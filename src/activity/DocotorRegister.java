...
//	}
	...
	public DocotorRegister() {
		DRFrame = new FrameSet("医生注册","E://Pictures//do.jpg");
		DRFrame.setFrame(100,100,541,743);
		jFrame = DRFrame.getJFrame();
